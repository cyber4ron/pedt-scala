...
//  println(xv getOrElse "None") // Vector(10.0) ?
//
//  // word count
...
//  println(y getOrElse "None")
  ...
  println("===> " + Conversions.nashornToString(zr))
  ...
  println("===> " + Conversions.nashornToString(ar))
